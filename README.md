...
- Easier functional scripts *(eg. [**./uninstall**](https://github.com/heckerxgamer/SERVER-BY-HxG/blob/main/README.md#uninstallremove-the-server) allows you to delete your server easily)*
...
> [**Join the Discord Server**](https://dsc.gg/HxG)
### To do list
...
```
git clone https://github.com/heckerxgamer/SERVER-BY-HxG
```
* Go into `SERVER-BY-HxG` directory:
```
cd SERVER-BY-HxG
```
...
cd ..
```
- And [Restart the Server](https://github.com/heckerxgamer/SERVER-BY-HxG/blob/main/README.md#restarting-your-server).
...
- [Restart](https://github.com/heckerxgamer/SERVER-BY-HxG/blob/main/README.md#restarting-your-server) your server after you apply these changes.

## Access Server Files
If you want to access your server files, go to `Open Editor` on the top right.
- Once you there, if you don't see any folders on the left side, you can `Open Folder` and pick `SERVER-BY-HxG` and go to `server` to view and modify anything inside.
...
## Older Version
If you are using older version of Minecraft check out [this](https://github.com/heckerxgamer/SERVER-BY-HxG/wiki/Version) documentation and install it according to your need:
...
- Go to `SERVER-BY-HxG` or `../SERVER-BY-HxG/` directory and do this command.
...
- If you want to make a new or delete your server, do this command inside `~/SERVER-BY-HxG`:
```
./uninstall
```
...
```
sudo rm -r SERVER-BY-HxG
```
If the project is completely deleted, you can [Clone the Project](https://github.com/heckerxgamer/SERVER-BY-HxG/blob/main/README.md#installation) again and it should be up to date with the new features and code from this project!
## Conclusion
Now you can host your very own Minecraft Server for both Java & Bedrock fast and easy and it won't cost you a single penny to make a fast and strong server. Best of all, IT'S FOREVER! Feel free to leave any requests you would like me to add into the project. If you have any issues, go to the [**Issues**](https://github.com/heckerxgamer/SERVER-BY-HxG/issues) tab and submit a issue there.
## Credits
> Project Creator: *[HECKER x GAMER](https://github.com/heckerxgamer)*
